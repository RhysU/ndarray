...
(for-each
  (lambda (under-test)
    ...
    (let ((c (make-ndarray under-test (make-dope stride-c `(2 3))))
      ...
      (test-eq c (ndarray-set! c 23 1 0))
      (test-eq c (ndarray-set! c 17 0 1))
      (test-eq f (ndarray-set! f 23 1 0))
      (test-eq c (ndarray-set! c 31 1 2))
      (test-eq f (ndarray-set! f 29 1 1))
      (test-eq c (ndarray-set! c 13 0 0))
