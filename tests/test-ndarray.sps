...
(test-eq +0 (slice-step (make-slice 0 10 +0) 555))
(test-eq -1 (slice-step (make-slice 0 10 -1) 555))
(test-eq -2 (slice-step (make-slice 0 10 -2) 555))
...
(test-eq +2 (slice-start (make-slice 2 10 +0) 555))
...
(test-eq +554 (slice-start (make-slice #f #f -1) 555))
(test-eq +554 (slice-start (make-slice #f #f -2) 555))
(test-eq +554 (slice-start (make-slice #f 678 -1) 555))
(test-end)
