...
; TODO Adjust tests to use test-eqv where appropriate
...
(let ((s (make-slice 0 10 1)))
  (test-equal 0 (sliver-start (make-sliver s 5)))
  (test-equal 5 (sliver-stop (make-sliver s 5)))
  (test-equal 9 (sliver-stop (make-sliver s 9)))
  (test-equal 0 (sliver-stop (make-sliver s 0)))
  (test-equal 1 (sliver-step (make-sliver s 5))))
(let ((s (make-slice 0 10 2)))
  (test-equal 0 (sliver-start (make-sliver s 5)))
  (test-equal 5 (sliver-stop (make-sliver s 5)))
  (test-equal 9 (sliver-stop (make-sliver s 9)))
  (test-equal 0 (sliver-stop (make-sliver s 0)))
  (test-equal 2 (sliver-step (make-sliver s 5))))
(let ((s (make-slice 3 10 1)))
  (test-equal 3 (sliver-start (make-sliver s 5)))
  (test-equal 5 (sliver-stop (make-sliver s 5)))
  (test-equal 9 (sliver-stop (make-sliver s 9)))
  (test-equal 3 (sliver-stop (make-sliver s 0)))
  (test-equal 1 (sliver-step (make-sliver s 5))))
(let ((s (make-slice 0 0 1)))
  (test-equal 0 (sliver-start (make-sliver s 5)))
  (test-equal 0 (sliver-stop (make-sliver s 5)))
  (test-equal 0 (sliver-stop (make-sliver s 0)))
  (test-equal 1 (sliver-step (make-sliver s 5))))
(let ((s (make-slice 0 0 -1)))
  (test-equal 0 (sliver-start (make-sliver s 5)))
  (test-equal 0 (sliver-stop (make-sliver s 5)))
  (test-equal -1 (sliver-stop (make-sliver s 0)))
  (test-equal -1 (sliver-step (make-sliver s 5))))
(let ((s (make-slice 10 #f -1)))
  (test-equal 4 (sliver-start (make-sliver s 5)))
  (test-equal -1 (sliver-stop (make-sliver s 5)))
  (test-equal -1 (sliver-stop (make-sliver s 0)))
  (test-equal -1 (sliver-step (make-sliver s 5))))
(test-end)
